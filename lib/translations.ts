...
export const translations = {
  de: {
    ...
    cars: {
      ...
      items: [
        { name: "Executive Sedan", image: "/images/merc1.webp" },
        { name: "Premium SUV", image: "/images/merc2.webp" },
        { name: "Business Van", image: "/images/merc3.webp" },
        { name: "Airport Transfer Sedan", image: "/images/merc4.webp" },
        { name: "City Ride SUV", image: "/images/merc5.webp" },
        { name: "Private Pickup Van", image: "/images/merc6.webp" },
      ],
    },
    contact: {
      eyebrow: "Kontakt",
